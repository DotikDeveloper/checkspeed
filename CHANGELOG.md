...
- **добавление явных требований к версии Node.js**: добавлено поле `engines` в package.json с требованиями Node.js `^20.19.0 || ^22.12.0 || >=24.0.0` для точного соответствия требованиям `jsdom` 27.4.0 и `lru-cache` 11.2.4, исключая неподдерживаемую версию Node.js 21.x. Обновлён Dockerfile для использования Node.js LTS версии (`node:lts-alpine`) вместо Node.js 18 для соответствия новым требованиям и обеспечения долгосрочной поддержки.
