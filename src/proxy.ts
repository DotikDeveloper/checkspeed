 ...
 * - Download/Upload: 3 размера × 2 измерения × 3 потока = 18 запросов на направление
 * - Ping: 8 попыток
 * Итого: ~44 запроса на один полный цикл testDownload+testUpload
 * UI: 10 итераций × 44 + ping ≈ 450 запросов
 */
